# Simple ANN Regression Model using PyTorch (GPU) with Shapley Explanations

## Project Description

This repository is a dockerized implementation of the Simple ANN regressor using PyTorch (running on GPU). It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- A **Simple ANN Regression** algorithm using PyTorch (GPU)
